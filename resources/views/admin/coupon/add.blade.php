              ...
              <div class="card-body">
                <div class="col-lg-12">
                  ...
                  <br>
                   ...
                   <div class="col-lg-12">
                      <form method="POST" name="brand-form" id="brand-form" action="{{route('coupon.store')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                          <div class="col-sm-4">
                        ...
                        <div class="row">
                          <div class="col-sm-4">
                            <div class="form-group">
                               ...
                               <input type="text" name="offer_code" class="form-control" id="offer_code" required placeholder="Enter Coupon code">
                            </div>    
                          </div> 
                          ...
                          <div class="col-sm-4">
                            <div class="form-group">
                               ...
                               <input type="text" name="amount" class="form-control" id="amount" required placeholder="Enter Coupon Amount">
                            </div>    
                          </div> 
