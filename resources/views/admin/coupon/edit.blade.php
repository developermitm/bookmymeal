...
@section('content')
 <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit New Coupon</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body">
                <div class="col-lg-12">
                  ...
                  <div class="text-right">
                    <a href="{{url('coupon-list')}}" class="btn bnt-sm customBtn"> <i class="fa fa-list"></i> Coupon List</a>
                  </div>
                  <br>
                </div>
                   <div class="col-lg-12">
                      <form method="POST" name="brand-form" id="brand-form" action="{{route('coupon.update', $getDetails->id)}}" enctype="multipart/form-data">
                        @method('PATCH')
                        {{ csrf_field() }}
                        <div class="row">
                          <div class="col-sm-4">
                        ...
                        <div class="row">
                          <div class="col-sm-4">
                            <div class="form-group">
                               ...
                               <input type="text" name="offer_code" class="form-control" value="{{!empty($getDetails->code) ? $getDetails->code : '' }}" id="offer_code" required placeholder="Enter Coupon code">
                            </div>    
                          </div> 
                          ...
                          <div class="col-sm-4">
                            <div class="form-group">
                               ...
                               <input type="text" name="amount" class="form-control" value="{{!empty($getDetails->amount) ? $getDetails->amount : '' }}" id="offer_code" required placeholder="Enter Coupon Amount">
                            </div>    
                          </div> 
